export const logo = "/logo-principal.png";
export const phone = "/phone.png";
export const whatsapp = "/whatsapp.png";
export const mail = "/mail.png";
export const rotationLeft = "/rotation-left.png";
export const shape = "/shape.png";
export const paperplane = "/paperplane.png";
export const calendar = "/calendar.png";
export const facebook = "/facebookIcon.png";
